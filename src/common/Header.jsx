                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className={`menuList ${isMenuOpen ? 'max-lg:left-0' : 'max-lg:left-[-100%]'} z-10 gap-11 max-lg:gap-8 max-lg:w-full max-lg:fixed max-lg:justify-center max-lg:top-0 max-lg:bg-white max-lg:transition-all duration-300 flex items-center max-lg:min-h-screen`}>
                        <ul className='flex flex-col lg:flex-row gap-11 max-lg:gap-8 items-center lg:items-center z-10'>
                            ...
                            <li onClick={toggleMenu}><a target='blank' className='font-inter font-medium text-lg leading-custom-xl text-black relative after:absolute hover:after:bg-black hover:after:left-0 after:w-0 hover:after:w-full hover:after:h-[2px] after:left-0 hover:after:bottom-[-3px] after:ease-in-out after:duration-300' href="/hlo">News</a></li>
                            <li className='lg:flex-row flex max-lg:flex-col items-center max-lg:gap-8'><a onClick={toggleMenu} target='blank' className='font-inter font-medium text-lg leading-custom-xl text-black relative after:absolute hover:after:bg-black hover:after:left-0 after:w-0 hover:after:w-full hover:after:h-[2px] after:left-0 hover:after:bottom-[-3px] after:ease-in-out after:duration-300' href="#tokenomics">Contact Us</a>
