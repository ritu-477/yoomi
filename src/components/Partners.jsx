  ...
  return (
    <div className='lg:py-[43px] md:py-8 py-6'>
      <div className='container'>
        ...
        <h2 className='xl:text-custom-4xl xl:leading-custom-4xl sm:text-custom-3xl sm:leading-custom-3xl font-normal text-2xl text-center max-w-[684px] mx-auto'>Recognized by Leading <span className='font-semibold'>Healthcare Institutions</span></h2>
