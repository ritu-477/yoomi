        ...
        <div className='lg:flex-row flex justify-between flex-col gap-6 sm:gap-8 md:gap-10'>
          <div className='max-w-[468px] w-full flex flex-col lg:items-end xl:ms-0 lg:ms-[50px]'>
            <div className='lg:max-w-[468px] w-full'>
              <p className='font-inter font-medium text-base leading-custom-lg text-deep-blue'>Library</p>
              ...
              <div className='flex gap-4 items-center mt-5'>
                <Icon iconName="click" />
                <p className='font-inter font-normal text-base text-black opacity-70 lg:max-w-[361.44px]'>Utilize Yoomi’s HEP templates to quickly create and assign programs to your patients </p>
              </div>
              <div className='flex gap-4 items-center pt-2'>
                <Icon iconName="click" />
                <p className='font-inter font-normal text-base text-black opacity-70 lg:max-w-[362.33px]'>Choose from our library of exercises for all patient cases</p>
              </div>
              <div className='flex gap-4 items-center pt-2'>
                <Icon iconName="click" />
                <p className='font-inter font-normal text-base text-black opacity-70 lg:max-w-[371.44px]'>Use Yoomi’s industry-leading exercise generation tool to create your own exercises that track adherence and form in seconds</p>
              </div>
              <button className='font-inter rounded font-semibold text-base leading-custom-lg py-4 sm:mt-10 mt-6 text-white px-8 bg-deep-blue hover:scale-[0.9] ease-out duration-300'>View the Library</button>
            </div>
          </div>
                ...
                <SwiperSlide key={idx}>
                  ...
                  >
                    <img
                      ...
                      className='w-full h-full pointer-events-none group-hover:scale-105 transition_slow'
                      alt='swiper-image'
                      width={461}
                      height={332}
                      priority
