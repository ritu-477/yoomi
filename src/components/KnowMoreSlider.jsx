  ...
  return (
    <div className="md:pt-12 pt-6 xl:pb-[92px] md:pb-[60px] pb-10">
      <div className="container">
        <p className="mx-auto w-fit text-deep-blue font-inter uppercase font-medium text-sm sm:text-base pb pb-3 xl:pb-4">
          Know More
        </p>
        ...
        <div className="max-w-[946px] w-full mx-auto">
          ...
          <div className="max-w-[723px] mx-auto md:-ml-2.5 lg:ml-auto md:mt-5 lg:pt-0.5">
            <Swiper
